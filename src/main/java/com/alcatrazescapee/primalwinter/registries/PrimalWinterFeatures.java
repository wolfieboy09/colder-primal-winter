...
public class PrimalWinterFeatures {
    public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(Registries.FEATURE, PrimalWinter.MOD_ID);

    public static final DeferredHolder<Feature<?>, ImprovedFreezeTopLayerFeature> FREEZE_TOP_LAYER = register("freeze_top_layer", ImprovedFreezeTopLayerFeature::new, NoneFeatureConfiguration.CODEC);
    public static final DeferredHolder<Feature<?>, ImprovedIceSpikeFeature> ICE_SPIKES = register("ice_spikes", ImprovedIceSpikeFeature::new, NoneFeatureConfiguration.CODEC);
    public static final DeferredHolder<Feature<?>, DiskFeature> DISK = register("disk", DiskFeature::new, DiskConfiguration.CODEC);

    private static <C extends FeatureConfiguration, F extends Feature<C>> DeferredHolder<Feature<?>, F> register(String name, Function<Codec<C>, F> feature, Codec<C> codec) {
    ...
    public static final class Keys {
        ...
        private static ResourceKey<PlacedFeature> key(String name) {
            return ResourceKey.create(Registries.PLACED_FEATURE, PrimalWinter.id(name));
        }
    }
